...
use App\Filament\Resources\HomeLocationPageResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Resources\HomeLocationPageResource\RelationManagers;



class HomeLocationPageResource extends Resource
{
    ...
    protected static ?string $model = HomeLocationPage::class;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            Tables\Columns\TextColumn::make('heading')
                ->label('Nazwa')
                ->description(function (HomeLocationPage $record) {
    ...
    {
        return [
            'index' => Pages\ListHomeLocationPages::route('/'),
            'create' => Pages\CreateHomeLocationPage::route('/create'),
            'edit' => Pages\EditHomeLocationPage::route('/{record}/edit'),
        ];
    }

    public static function getNavigationLabel(): string
    {
        return ('Strona Lokalizacja');
    }
